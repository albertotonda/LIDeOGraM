...
class QtConnector:
    def __init__(self,vwApp,cntrApp):
        ...
        self.vwApp.buttonAddConstraint.clicked.connect(self.cntrApp.clickAjContrainte)
        self.vwApp.buttonRemoveConstraint.clicked.connect(self.cntrApp.RemoveConstraint)
