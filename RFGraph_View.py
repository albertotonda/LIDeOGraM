...
class RFGraph_View(QtGui.QMainWindow):
    ...
    def __init__(self,modApp):
        ...
        self.gridLayout.addWidget(self.networkGUI, 1, 0, 9, 60)
        ...
        self.gridLayout.addWidget(self.adjThreshold_lab, 10, 0, 1, 2)
        self.gridLayout.addWidget(self.adjThreshold_slider, 10, 2, 1, 57)
